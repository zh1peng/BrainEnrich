...
#saveRDS(annoData, file = "extdata/geneSets/GO_BP.rds")
annoData <- get_GO_data("org.Hs.eg.db", ont = 'MF', keytype = "SYMBOL")
#saveRDS(annoData, file = "extdata/geneSets/GO_MF.rds")
annoData <- get_GO_data("org.Hs.eg.db", ont = 'CC', keytype = "SYMBOL")
save(annoData, file = "extdata/geneSets/GO_CC.rds")
...
```{r include=T, eval=F}
 ...
 save(annoData, file = "extdata/geneSets/DGN.rds")
 packageVersion("DOSE")
```
...
#saveRDS(annoData, file = "extdata/geneSets/KEGG.rds")
packageVersion("clusterProfiler")
```
...
#saveRDS(annoData, file = "extdata/geneSets/WikiPathways.rds")
packageVersion("clusterProfiler")
```
...
#saveRDS(annoData, file = "extdata/geneSets/Reactome.rds")
```
...
build_Anno <- getFromNamespace("build_Anno", "DOSE")
annoData <- build_Anno(TERM2GENE, TERM2NAME)
#saveRDS(annoData, file = "extdata/geneSets/SynGO.rds")
```
...
annoData <- build_Anno(TERM2GENE, TERM2NAME)
#saveRDS(annoData, file = "extdata/geneSets/CellTypes_Seidlitz2020.rds")
```
...
TERM2NAME <- TERM2GENE %>%
  ...
  dplyr::select(term, description)
annoData <- build_Anno(TERM2GENE, TERM2NAME)
#saveRDS(annoData, file = "extdata/geneSets/CellTypes_Lake2018.rds")
```
...
TERM2NAME <- TERM2GENE %>%
  ...
  dplyr::select(term, description)
annoData <- build_Anno(TERM2GENE, TERM2NAME)
#saveRDS(annoData, file = "extdata/geneSets/CellTypes_Martins2021.rds")
```
