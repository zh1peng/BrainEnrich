...
res_list[[paste(gs_type, null_model, cor_method, aggre_method, minGSSize, maxGSSize, iter_total,sep="_")]] <- res
    }
  }
}

saveRDS(res_list, file = file.path(res_path,"res_list.rds"))
```
