...
This tutorial demonstrates how to perform simulations to assess the false positive rate of analysis with brainscore.
...
For demonstration purposes, we have used a small number of iterations (sim_n = 2) and one subsample size (subsample_size = 100). In practice, we recommend using a larger number of iterations (i.e. 1000), various subsample sizes (e.g., 50, 100, 150, 200) and larger size of null models for a more robust analysis.
