...
As generate the null gsScore is time-consuming, we can use the pre-calculated null gsScore to speed up the analysis.
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
### 2.6. Simulation analysis with resample_gene (`sim_type ='resample_gene'`) and pre-calculated null gsScore
As generate the null gsScore is time-consuming, we can use the pre-calculated null gsScore to speed up the analysis.
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
# pre-calculate the null gsScore
