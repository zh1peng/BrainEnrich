...
Core genes are selected with a leave-one-out analysis. A gene is labeled `driver` when removing it changes
the summary statistic in the same direction as the observed effect, and `buffer` when the sign flips.
The size of the bar reflects the absolute leave-one-out impact, so taller bars indicate stronger influence.
