...
cnetplot(res, layout='kk', color_category='#a6a6a6', foldChange=geneList,
          ...
          showCategory = 10, cex.params = list(category_node=1, gene_node=0.75,
...
heatplot(res,foldChange=geneList,label_format=50, showCategory = 10)+
  scale_fill_gradient2(midpoint=0,low='#0197b2',mid='white',high='orange',
                         space ="Lab" ,limits = c(-1,1), name='Association')
```
...
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center', fig.height=10, fig.width=10}
 ...
 res=pairwise_termsim(res, method="Wang", semData = d)
  treeplot(res,
            ...
            nWords = 2,
            color='p.adjust',
            offset = rel(2))+theme(legend.position = c(0.95,0.46))
```
...
rmarkdown::render(input = file.path(rmd_path,"brainenrich_demo.rmd"),
