---
title: "brainenrich (demo):Enrichment analysis of group-level IDPs"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{brainenrich (demo):Enrichment analysis of group-level IDPs}
...
First, we define a plot function (this will not be included in the package).
```{r}
library(ggseg)
#' Plot Brain Data
#'
